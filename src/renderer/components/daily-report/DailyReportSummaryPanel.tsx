...
import { DailyReportTimeTracker } from "@/components/daily-report/DailyReportTimeTracker";
    ...
    <div className="flex h-full min-h-0 flex-col rounded-lg border border-zinc-200 bg-[var(--ui-panel-bg)] dark:border-zinc-700">
      ...
      <div className="flex min-h-0 flex-1 flex-col">
        <Tabs defaultValue="summary" className="flex min-h-0 flex-1 flex-col">
          <div className="border-b border-[var(--ui-panel-border)] px-3 py-2">
          ...
          <TabsContent
            ...
            className="mt-0 flex min-h-0 flex-1 flex-col overflow-hidden focus-visible:outline-none"
          >
            <DailyReportTimeTracker embedded />
          </TabsContent>
        </Tabs>
      </div>
    </div>
